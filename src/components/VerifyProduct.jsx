  ...
  const statusMessage = (status) => {
    switch (status) {
      ...
      case "ALREADY_CONSUMED":
        return <h3 style={{ color: 'red' }}>⚠ WARNING: This product has already been sold. This may be a counterfeit.</h3>;
      case "NOT_YET_IN_STORE":
        return <h3 style={{ color: 'orange' }}>ℹ Info: This product is in transit but not yet active at a retail store.</h3>;
      default:
